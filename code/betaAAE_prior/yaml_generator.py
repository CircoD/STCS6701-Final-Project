...
TO_Override['training_config']['tb_log_dir'] = f"./runs/betaAAE_prior_beta={TO_Override['training_config']['beta']}."
...
def generate_config_beta_noise(Beta=1):
    ...
    TO_write['training_config']['tb_log_dir'] = f"./runs/betaAAE_prior_beta={TO_write['training_config']['beta']}."
